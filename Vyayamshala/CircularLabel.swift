...
class CircularLabel: UILabel {
    ...
    override func draw(_ rect: CGRect) {
        ...
        context.translateBy (x: size.width / 6, y: size.height / 2)
        context.scaleBy (x: 1, y: -1)
        
        centreArcPerpendicular(text: "Hello round world", context: context, radius: 50, angle: 90, colour: UIColor.red, font: UIFont.systemFont(ofSize: 16), clockwise: true)
